...
public class BattlesScreenCancer extends Screen implements BattleInterface, BattlesActions, ActionListener, KeyListener , MouseListener,MouseMotionListener{
	/**
	 * ***********CHANGES! MUST READ********************
	 * RENAMING: 
	 * 	VARIABLES
	...
	public BattlesScreenCancer(Game game){
		super(game);
		Projectile();
		Weapon();
		MainCharacter();
...
//		}
	...
	public void doSomething(MouseEvent e){
		controller.determineMouseAction(e,this);
	}
	@Override
...
//	}
	...
	public void setFireType(boolean rifle) {
		character.setRifle(rifle);
		// TODO Auto-generated method stub
...
//		// TODO Auto-generated method stub
//		//sets the idle sprite based on what key has beeen released. e.g.: W sets facing u/
//		//A sets facing left, etc...
//		
//	}
}
